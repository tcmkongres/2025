...
const tcmKey = {
  title: "tcm-key-section-title",
  titleNext: "tcm-key-section-title-next",
  description: "tcm-key-section-description",
  descriptionNext: "tcm-key-section-description-next",
};
